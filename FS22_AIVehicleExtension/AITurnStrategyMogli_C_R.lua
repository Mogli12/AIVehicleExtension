...
function AITurnStrategyMogli_C_R:getNextStage( dt, vX,vY,vZ, turnData, stageId )
	...
	if     stageId == 1 then
		veh:aiFieldWorkerTurnProgress( 0.01, veh.acParameters.leftAreaActive )
	...
	elseif stageId == 2 then
		veh:aiFieldWorkerTurnProgress( 0.3, veh.acParameters.leftAreaActive )
		self:fillStages( turnData )
		return self:getStageFromPoints( self.stages[1], true, 0, true )
	elseif stageId == 3 then
		veh:aiFieldWorkerTurnProgress( 0.6, veh.acParameters.leftAreaActive )
	...
	elseif stageId == 4 then
		veh:aiFieldWorkerTurnProgress( 0.8, veh.acParameters.leftAreaActive )
	...
	elseif stageId == 5 then
		veh:aiFieldWorkerTurnProgress( 0.99, veh.acParameters.leftAreaActive )
